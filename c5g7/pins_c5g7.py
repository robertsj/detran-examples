...
def get_pins(number, flag) :
  ...
  radii = [0.54]
  # Pin 0 - UO2 
  pin0 = PinCell(pitch, [0,6], radii)
  pin0.meshify(number, flag)
  # Pin 1 - 4.3% MOX
  pin1 = PinCell(pitch, [1,6], radii)
  pin1.meshify(number, flag)
  # Pin 2 - 7.0% MOX
  pin2 = PinCell(pitch, [2,6], radii)
  pin2.meshify(number, flag)
  # Pin 3 - 8.7% MOX
  pin3 = PinCell(pitch,[3,6], radii)
  pin3.meshify(number, flag)
  # Pin 4 - Guide Tube
  pin4 = PinCell(pitch,[4,6], radii)
  pin4.meshify(number, flag)
  # Pin 5 - Fission Chamber
  pin5 = PinCell(pitch, [5,6], radii)
  pin5.meshify(number, flag)
  # Pin 6 - Moderator
  pin6 = PinCell(pitch, [6,6], radii)
